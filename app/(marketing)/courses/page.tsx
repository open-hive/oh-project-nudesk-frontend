...
const ACCESS_TYPES = ["Free only", "Subscriber content"];
    ...
    <aside className="w-[260px] shrink-0 self-start sticky top-[90px]">
      <div className="bg-white border-[1.5px] border-neutral-200 rounded-2xl px-5 py-2">
        ...
        <SidebarSection title="Access type">
          {ACCESS_TYPES.map((r) => <RadioItem key={r} label={r} name="access_type" />)}
          <p className="text-xs text-neutral-400 mt-1">
            Paid courses are unlocked with a tutor subscription.
          </p>
        </SidebarSection>
                    ...
                    >
                      ...
                      <div className="px-[18px] pt-4 pb-5">
                        ...
                        <div className="flex items-center justify-between">
                          <Link href={`/tutors/${c.tutor}`} className="text-[.8rem] font-medium text-neutral-700 hover:text-violet-700">
                            {c.tutor_name}
                          </Link>
